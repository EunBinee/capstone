...
public class DialogueParser : MonoBehaviour
{
    ...
    //                        }
    //                        line.Name = in_name;
    //                        contextList.Add(row[4]); //대사를 리스트에 추가.
    //                    }
    //                    else if (startChoice)  //선택지 O
    //                    {
    //                        choice_OneTwo++;
    ...
    //                            line.choice.firstOption = row[6].ToString(); //선택지 대사
    //                            line.choice.firstSkipDialogNum = int.Parse(row[7]); //스킵라인

    //                            if (row[8]!= "") //퀘스트 번호가 있는지
    //                            {
    //                                //있으면 퀘스트 실행되게 하기.
    ...
    //                        {
    //                            //두번째 선택지
    //                            line.choice.secondOption = row[6].ToString(); //선택지 대사
    //                            line.choice.secondSkipDialogNum = int.Parse(row[7]); //스킵라인
    ...
    //                } while (row[3] == "");    //캐릭터 이름이 비어있으면 대사 이어짐.
